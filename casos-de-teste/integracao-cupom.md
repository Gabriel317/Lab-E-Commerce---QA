...
Testes de integração via API (Postman) e via interface com DevTools, validando o fluxo de carrinho, aplicação de cupom e checkout no e-commerce de treino. Autenticação via JWT, com papéis CLIENTE e ADMIN.
